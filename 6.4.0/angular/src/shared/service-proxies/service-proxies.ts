...
@Injectable()
export class StudentManagerServiceProxy {
    private http: HttpClient;
    private baseUrl: string;
    protected jsonParseReviver: ((key: string, value: any) => any) | undefined = undefined;
     ...
     * @return Success
     */
    studentCreator(body: StudentDto | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/StudentManager/StudentCreator";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("post", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            return this.processStudentCreator(response_);
        })).pipe(_observableCatch((response_: any) => {
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processStudentCreator(<any>response_);
                } catch (e) {
                    return <Observable<void>><any>_observableThrow(e);
                }
            } else
    ...
    protected processStudentCreator(response: HttpResponseBase): Observable<void> {
        const status = response.status;
        const responseBlob =
            response instanceof HttpResponse ? response.body :
            (<any>response).error instanceof Blob ? (<any>response).error : undefined;
    ...
    getStudents(): Observable<StudentDto[]> {
        let url_ = this.baseUrl + "/api/services/app/StudentManager/GetStudents";
        url_ = url_.replace(/[?&]$/, "");
    ...
    getStudent(id: number | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/StudentManager/GetStudent?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
     ...
     * @return Success
     */
    updateStudent(body: StudentDto | undefined): Observable<StudentDto> {
        let url_ = this.baseUrl + "/api/services/app/StudentManager/UpdateStudent";
        url_ = url_.replace(/[?&]$/, "");
        ...
        return this.http.request("put", url_, options_).pipe(_observableMergeMap((response_ : any) => {
            ...
            if (response_ instanceof HttpResponseBase) {
                try {
                    return this.processUpdateStudent(<any>response_);
                } catch (e) {
                    return <Observable<StudentDto>><any>_observableThrow(e);
                }
            } else
    ...
    deleteStudent(id: number | undefined): Observable<void> {
        let url_ = this.baseUrl + "/api/services/app/StudentManager/DeleteStudent?";
        if (id === null)
            throw new Error("The parameter 'id' cannot be null.");
        else if (id !== undefined)
            url_ += "Id=" + encodeURIComponent("" + id) + "&";
