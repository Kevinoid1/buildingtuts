...
{
    public abstract class BuildingTutsWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static BuildingTutsWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(BuildingTutsWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<BuildingTutsDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<BuildingTutsDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<BuildingTutsDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<BuildingTutsDbContext, Task<T>> func)
        {
            T result;
